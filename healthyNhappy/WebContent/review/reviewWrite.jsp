...
<div id="box">
	...
	<div class="list" style="text-align: left">
		...
		<input type="hidden" name="id" value="<%=mem.getId() %>">
			<table>
			<col width="100px">
			<caption><b>후기작성</b></caption>
			<tr>
				<td>제목</td><td><input type="text" size="60px" name="title" id="title">
				</td>
			</tr>
			<tr>
				<td>평점</td>
			...
			<tr>
				<td>내용</td>
				<td><textarea rows="10" cols="60" name="content" id="content"></textarea></td>
			</tr>
			<tr>
				<td>파일 첨부</td><td><input type="file" name="fileload" id="upload"></td>
			</tr>
			...
			<div align="center">
				...
				<input class="btn" type="submit" id="writebtn" value="등록">
			</div>
...
$("#writebtn").click(function(){
	...
	if( $("#title").val().trim() == "" ){
		...
		$("#frm").attr("action", "../product?work=reviewWrite&prd_num=<%=prd_num %>").submit();
	}
